<template>
  <button @click="gameStore.toggleSidebar()" class="hamburger-menu">
    ☰
  </button>

  <aside class="sidebar" :class="{ 'is-open': gameStore.isSidebarOpen }">
  ...
  <div v-if="gameStore.gameId">
    ...
    <Navigation v-if="!gameStore.isSidebarOpen" />
  </div>
  <div v-else>
